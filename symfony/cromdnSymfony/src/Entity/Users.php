 ...
 * Users
 *
 * @ORM\Table(name="users", uniqueConstraints={@ORM\UniqueConstraint(name="users_email_unique", columns={"email"})}, indexes={@ORM\Index(name="users_id_role_foreign", columns={"id_role"})})
 * @ORM\Entity
 */
class Users
{
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="email_verified_at", type="datetime", nullable=true, options={"default"="CURRENT_TIMESTAMP"})
     */
    private $emailVerifiedAt = 'CURRENT_TIMESTAMP';
